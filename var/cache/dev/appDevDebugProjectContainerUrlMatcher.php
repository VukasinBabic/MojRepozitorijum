...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/images/9aaaf5d')) {
            // _assetic_9aaaf5d
            if ($pathinfo === '/images/9aaaf5d.png') {
                return array (  '_controller' => 'assetic.controller:render',  'name' => '9aaaf5d',  'pos' => NULL,  '_format' => 'png',  '_route' => '_assetic_9aaaf5d',);
            }

            // _assetic_9aaaf5d_0
            if ($pathinfo === '/images/9aaaf5d_logo_1.png') {
                return array (  '_controller' => 'assetic.controller:render',  'name' => '9aaaf5d',  'pos' => 0,  '_format' => 'png',  '_route' => '_assetic_9aaaf5d_0',);
            }
        ...
        if (0 === strpos($pathinfo, '/article')) {
            // article_list
            if (0 === strpos($pathinfo, '/articles') && preg_match('#^/articles(?:/(?P<_locale>en|sr|de)(?:/(?P<page>\\d+)(?:\\.(?P<_format>html|rss))?)?)?$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'article_list')), array (  '_controller' => 'AppBundle\\Controller\\ArticleController::listAction',  'page' => 1,  '_locale' => 'sr',  '_format' => 'html',));
            }
            ...
            // article_update
            if (0 === strpos($pathinfo, '/article/update') && preg_match('#^/article/update/(?P<id>\\d+)$#s', $pathinfo, $matches)) {
            ...
            // article_show
            if (preg_match('#^/article/(?P<id>\\d+)/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
